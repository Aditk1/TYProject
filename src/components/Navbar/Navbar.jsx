  ...
  return (
    <div className="navbar bg-white shadow-md">
      <div className="container mx-auto px-4 py-2 flex justify-between items-center">
        ...
        {!token ? <button onClick={() => setShowLogin(true)} className="sign-up bg-orange-500 text-white px-4 py-2 rounded-lg font-bold transition-transform duration-300 hover:bg-orange-600 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-orange-300">Sign In</button>
